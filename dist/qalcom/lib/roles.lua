...
"network.send", "network.receive", "network.configure", "network.pair", "network.control", "telemetry.read", "incident.manage", "cannon.control", "system.reboot",
},
},
["Operations officer"] = {
...
capabilities = {
"fs.read", "peripheral.read", "network.receive", "telemetry.read", "cannon.control",
},
},
Engineer = {
label = "Engineer",
...
"redstone.control", "infrastructure.control", "infrastructure.emergency", "network.receive", "telemetry.read", "incident.manage", "cannon.control",
},
},
["Logistics officer"] = {
