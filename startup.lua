...
if not ok then
    -- The supervisor may have re-skinned the 16-color palette before crashing.
    -- Best-effort restore of CC:T's stock palette so recovery text is legible
    -- and CraftOS is not left with Qalcom's colors.
